...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-1/3 hidden lg:flex relative bg-black">
        <img
          src="team.png"
          alt="Team celebrating"
          className="absolute w-full h-full object-cover opacity-80"
        />
        <div className="relative z-10 mx-auto mt-auto mb-16 text-white px-10 text-4xl font-semibold leading-snug">
          Where amazing
          <br />
          things happen
        </div>
      ...
      <div className="w-full lg:w-8/12 flex items-center justify-center px-4 sm:px-10">
          ...
          <SignedOut>
            {showSignUp ? (
              <SignUp
                appearance={{
                   elements: {
                card: "shadow-xl border border-gray-100 p-6 rounded-2xl",
            ...
            <div className="text-center mt-4 mr-8">
              {showSignUp ? (
