...
const AboutPage = () => {
  return (
    <div className="bg-[#e7d9f9]">
      ...
      <div className="bg-[#e8e6ff] py-16 px-6 sm:px-10 md:px-20 lg:px-44">
              ...
              {[
                ...
                <div key={idx}>
                  <div className="border-l-4 border-violet-600 pl-4">
                    ...
                    <p className="text-base text-gray-800 mt-1">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div className="bg-[#e8e6ff] py-16 px-6 sm:px-10 md:px-44">
        <h2 className="text-5xl font-semibold text-center text-gray-900 mb-12">
          Meet Our Leadership Team
        </h2>

        <div className="max-w-8xl mx-auto grid gap-10 sm:grid-cols-2 md:grid-cols-3 place-items-center">
          {[
            ...
            <div
              key={idx}
              className="bg-white rounded-xl shadow-md p-6 text-center w-52 hover:shadow-lg transition-shadow"
            >
              <img
      ...
      <div className="bg-[#e4e4fb] py-16 px-6 text-center">
        <h2 className="text-3xl md:text-5xl font-semibold text-gray-800 mb-4">
          Our Vibrant Culture
        </h2>
        <p className="max-w-2xl mx-auto text-gray-600 mb-12 text-base md:text-xl">
      ...
      <div className="bg-[#e4e4fb] py-16 px-4">
        <div className="bg-secondary max-w-7xl mx-auto rounded-md py-10 px-6 text-center shadow-md">
          ...
          <button className="bg-primary hover:bg-purple-700 text-white text-lg font-semibold py-2 px-4 rounded transition duration-200">
            Explore Careers
          </button>
        </div>
      </div>
